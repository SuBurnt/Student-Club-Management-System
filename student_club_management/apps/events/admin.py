...
class EventAdmin(admin.ModelAdmin):
    list_display = ('title', 'club', 'date_time', 'location', 'max_participants', 'registered_count')
    ...
    def cancel_all_registrations(self, request, queryset):
        ...
        self.message_user(request, f'Регистрации отменены для {queryset.count()} мероприятий')
